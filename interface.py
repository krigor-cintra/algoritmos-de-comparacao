...
Label(menu_inicial,text="Digite a lista:",background="#ff0",foreground="#009",anchor=W, font="Arial 20",).place(x=20,y=20,width=160,height=35)
...
def show():
    print(var.get())
    resultado=Label(menu_inicial, text=var.get()).pack()
var= IntVar()
